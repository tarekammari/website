...
export default function ItemCard({ item }: { item: CatalogItem }) {
  ...
  return (
    <div className="rounded-lg border border-foreground/10 p-4 bg-background/60 flex flex-col">
      ...
      <div className="flex items-center justify-between mt-2">
        ...
        <button
          className="text-sm rounded-md border border-foreground/20 px-3 py-1.5 hover:bg-foreground/5"
